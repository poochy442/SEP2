package viewmodel.hq.controlRetailer.deliveryRetailer;
...
public class DeliveryItemsRTVM {
     ...
     */
    public DeliveryItemsRTVM(IDataModel dataModel, ViewHandler viewHandler)
    {
    ...
    /**
     * The method called by the Listener added at {@link this#DeliveryItemsRTVM(IDataModel, ViewHandler)} (IDataModel, ViewHandler)}.
    ...
    public void openDeliveryClicked() {
        viewHandler.openDeliveryMainRTView();
    }


    public void openEmployeeMainView() {viewHandler.openEmployeeMainRTView();
    }

    public void goBack() {viewHandler.openDeliveryMainRTView();
    }
