...
public class DeliveryMainRTVM {
     ...
     */
    public DeliveryMainRTVM(IDataModel dataModel, ViewHandler viewHandler) {
    ...
    /**
     * The method called by the Listener added at {@link this#DeliveryMainRTVM(IDataModel, ViewHandler)} (IDataModel, ViewHandler)}.
    ...
    public void openDeliveryItemsView(Delivery delivery) {
        viewHandler.openDeliveryItemsRTView();
